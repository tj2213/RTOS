...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, ONBOARD_LED_Pin|EXTERNAL_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : ONBOARD_LED_Pin EXTERNAL_LED_Pin */
  GPIO_InitStruct.Pin = ONBOARD_LED_Pin|EXTERNAL_LED_Pin;
