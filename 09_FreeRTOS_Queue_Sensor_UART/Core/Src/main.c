...
/* Private variables ---------------------------------------------------------*/
/* Definitions for Sending_Task */
osThreadId_t Sending_TaskHandle;
const osThreadAttr_t Sending_Task_attributes = {
  .name = "Sending_Task",
  .stack_size = 128 * 4,
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of Sending_Task */
  Sending_TaskHandle = osThreadNew(Sensor_Read, NULL, &Sending_Task_attributes);
...
/**
  * @brief  Function implementing the Sending_Task thread.
